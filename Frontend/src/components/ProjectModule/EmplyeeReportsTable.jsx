...
export default function EmployeeTaskTable({
  ...
  useEffect(() => {
    const fetchTodayDayReports = async () => {
      if (!currentEmployeeId || projectType !== "concurrent") return;
  ...
  const isInTodayReport = (task) => {
    if (projectType !== "concurrent") return true;
            ...
            <tbody className="text-gray-800">
              {paginatedTasks && paginatedTasks.length > 0 ? (
                paginatedTasks.map((task, index) => {
                  ...
                  const isDisabled = projectType !== "concurrent";
                  const isFinalDisabled =
                    task.status === "Completed" ||
                    task.status === "underReview" ||
                    ["Hold", "Canceled"].includes(projectTab);
                  const isReportDisabled =
                    projectType === "concurrent" && isInTodayReport(task);
                    ...
                    >
                      ...
                      <td className="px-[0.6vw] py-[0.6vw] border border-gray-300">
                        <button
                          ...
                          disabled={
                            !isFinalDisabled && !isReportDisabled && !isDisabled
                          }
                          className={`
                            ${
                              !isFinalDisabled &&
              ...
              {!showHistory ? (
                ...
                <div className="px-[1vw] pt-[1vw] border-b border-gray-200 min-h-[79%] max-h-[79%]">
                  ...
                  {loadingHistory ? (
                    ...
                    <>
                      <div className="h-[38vh] overflow-y-auto rounded-xl overflow-hidden border border-gray-300  border-separate border-spacing-0 ">
